...
enum EPP_ERROR_CODE
{
    ...
    EPP_PORT_OPEN_ERROR,
    EPP_SEND_PACKET_ERROR,  // 1003
    EPP_PACKET_LEN_ERROR,
    EPP_RECV_TIMEOUT,  // 1005
    EPP_PACKET_LEN_TOO_LONG,
    EPP_CRC_CHECK_ERROR,  // 1007
    EPP_OPEN_FILE_ERROR,
    EPP_SEEK_FILE_ERROR,  // 1009
    EPP_WRITE_FILE_ERROR,
    EPP_READ_FILE_ERROR,  // 1011
    EPP_CONFIGURE_INVALID,
    EPP_CONFIGURE_MAC_ERROR,  // 1013
    EPP_NO_PIN,
    EPP_SEND_CMD_ERROR,  // 1015
    EPP_RECV_CMD_ERROR,
    EPP_RECV_RET_ERROR,  // 1017
    EPP_RECV_LEN_ERROR,
    EPP_MAC_CHECK_ERROR,  // 1019
    EPP_AUTHEN_FAILED,
    EPP_INPUT_PARAM_ERROR,  // 1021
    EPP_USER_PRESS_CANCEL,
    EPP_INPUT_CMD_ERROR,  // 1023
    EPP_INPUT_KEY_INDEX_ERROR,
    EPP_INPUT_MAC_LEN_ERROR, // 1025
    EPP_INPUT_MODE_ERROR,
    EPP_KEY_TYPE_ERROR,  // 1027
    EPP_KEY_INDEX_ERROR,
    EPP_MASTER_KEY_INDEX_ERROR,  // 1029
    EPP_BMP_ERROR,
    EPP_PIN_CFG_LANGE_TYPE_ERROR,  // 1031
    EPP_PIN_CFG_SYMBOL_TYPE_ERROR,
    EPP_INPUT_DATA_LEN_ERROR, // 1033
    EPP_SET_PORT_ERROR,
    EPP_CFG_ERROR,
    EPP_CLOSE_FAILED,
};
